#!/bin/bash
# Base service - Raspberry Pi 5 specific
# This script installs essential packages, RaspiOS kernel/firmware (rpi-2712 only), and sets up basic system configuration
set -e
